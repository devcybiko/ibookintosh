...
// int con_pin[] = { 23, 0, 22, 1, 21, 2, 20, 3, 19, 4, 18, 5, 17, 6, 29, 7, 31, 81   , 33, 9, 32, 10, 30, 11, 28, 12, 27, 26, 25, 24, 16, 15, 14 };
//  
...
//
int max_pin = 39;  // the keyboard FPC connector pin count. If set to 34, unsolder the LED or the code won't work
int min_pin = 1;   // the first pin to be tested on the FPC connector (usually pin 1)
//
// load the key codes used in sending usb numbers, tab, and down ar row
int key_1 = KEY_1;
int key_2 = KEY_2;
int key_3 = KEY_3;
int key_4 = KEY_4;
